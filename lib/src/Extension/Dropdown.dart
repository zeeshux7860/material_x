...
class MxDropdownLabel extends StatefulWidget {
  final String name;
  ...
  @override
  _MxDropdownLabelState createState() => _MxDropdownLabelState();
}

class _MxDropdownLabelState extends State<MxDropdownLabel> {
  @override
